...
function Board({ boardSize, xIsNext, squares, onPlay, mode, disabled }) {
...
function getAIMove(squares, boardSize) {
...
// check-某个位置是否会形成 3 连
function checkThreeInARow(squares, boardSize, position, player) {
  const directions = [
    [1, 0], // 水平
    [0, 1], // 垂直
    [1, 1], // 对角线
